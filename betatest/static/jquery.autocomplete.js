...
(function($) {
  ...
  Autocomplete.prototype = {
    ...
    fixPosition: function() {
      ...
      this.container.width(this.el.outerWidth() - 2);
    },
    ...
    suggest: function() {
      ...
      for (i = 0; i < len; i++) {
        ...
        title = this.data[i];
        div = $((me.selectedIndex === i ? '<div class="selected"' : '<div') + ' title="' + title + '">' + f(s, this.data[i], v) + '</div>');
    ...
    adjustScroll: function(i) {
      ...
      v = this.data[i];
      if (! v)
        v = this.suggestions[i];
      this.el.val(this.getValue(v));
    },
